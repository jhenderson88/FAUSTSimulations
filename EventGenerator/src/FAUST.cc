...
// ********************************************************************
//
// $Id: exampleHe3Barrel.cc 86065 2014-11-07 08:51:15Z gcosmo $
//
...
int main(int argc,char** argv)
{
	...
	PhysicsList *thePL = new PhysicsList();
	thePL->AddPhysicsList("QGSP_BERT_HP");
	thePL->AddPhysicsList("RadioactiveDecay");


	// set an HistoManager
	//
	new DetectorConstructionMessenger(detector);
	HistoManager* histo = 
		new HistoManager();
